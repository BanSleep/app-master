...
import 'address/search_address_widget.dart';

class ShopsMapPage extends StatefulWidget {
  const ShopsMapPage({Key? key, required this.items, required this.position})
      : super(key: key);
...
class _ShopsMapPageState extends State<ShopsMapPage> with AddressMixin {
    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          ...
          Positioned(
              bottom: 10.h,
              child: SearchAddressWidget(selectedAddress: _selectedAddress)),
        ],
      ),
    );
  }
